...
func testCategoryToManyContents(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = a.L.LoadContents(ctx, tx, false, (*[]*Category)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testCategoryToManyAddOpContents(t *testing.T) {
	var err error
...
func testCategoryToManySetOpContents(t *testing.T) {
	var err error
...
func testCategoryToManyRemoveOpContents(t *testing.T) {
	var err error
