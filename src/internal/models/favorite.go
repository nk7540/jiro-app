...
type Favorite struct {
	...
	IsMost       bool      `boil:"is_most" json:"is_most" toml:"is_most" yaml:"is_most"`
	ToUserIds    string    `boil:"to_user_ids" json:"to_user_ids" toml:"to_user_ids" yaml:"to_user_ids"`
	ToCloseUsers bool      `boil:"to_close_users" json:"to_close_users" toml:"to_close_users" yaml:"to_close_users"`
...
var FavoriteTableColumns = struct {
	...
	CommentID:    "favorite.comment_id",
	IsMost:       "favorite.is_most",
	ToUserIds:    "favorite.to_user_ids",
	ToCloseUsers: "favorite.to_close_users",
...
var FavoriteWhere = struct {
	...
	IsMost       whereHelperbool
	ToUserIds    whereHelperstring
	ToCloseUsers whereHelperbool
	...
	CommentID:    whereHelpernull_Int{field: "`favorite`.`comment_id`"},
	IsMost:       whereHelperbool{field: "`favorite`.`is_most`"},
	ToUserIds:    whereHelperstring{field: "`favorite`.`to_user_ids`"},
	ToCloseUsers: whereHelperbool{field: "`favorite`.`to_close_users`"},
...
var (
	favoriteAllColumns            = []string{"id", "user_id", "content_id", "comment_id", "is_most", "to_user_ids", "to_close_users", "created_at", "updated_at"}
	favoriteColumnsWithoutDefault = []string{"user_id", "content_id", "comment_id", "to_user_ids", "created_at", "updated_at"}
	favoriteColumnsWithDefault    = []string{"id", "is_most", "to_close_users"}
...
func (o *Favorite) Comment(mods ...qm.QueryMod) commentQuery {
...
func (o *Favorite) SetComment(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Comment) error {
	var err error
	if insert {
...
func (o *Favorite) RemoveComment(ctx context.Context, exec boil.ContextExecutor, related *Comment) error {
	var err error
	...
	for i, ri := range related.R.Favorites {
		if queries.Equal(o.CommentID, ri.CommentID) {
			continue
		}

		ln := len(related.R.Favorites)
		if ln > 1 && i < ln-1 {
			related.R.Favorites[i] = related.R.Favorites[ln-1]
		}
		related.R.Favorites = related.R.Favorites[:ln-1]
		break
	}
	return nil
}
