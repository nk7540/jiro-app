...
var (
	categoryAllColumns            = []string{"id", "name", "created_at", "updated_at"}
	categoryColumnsWithoutDefault = []string{"name", "created_at", "updated_at"}
...
func (o *Category) Contents(mods ...qm.QueryMod) contentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`content`.`category_id`=?", o.ID),
	)
...
func (categoryL) LoadContents(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCategory interface{}, mods queries.Applicator) error {
	var slice []*Category
	var object *Category
	...
	query := NewQuery(
		qm.From(`content`),
		qm.WhereIn(`content.category_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Category) AddContents(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Content) error {
	var err error
...
// Sets o.R.Category's Contents accordingly.
// Replaces o.R.Contents with related.
// Sets related.R.Category's Contents accordingly.
func (o *Category) SetContents(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Content) error {
	query := "update `content` set `category_id` = null where `category_id` = ?"
...
func (o *Category) RemoveContents(ctx context.Context, exec boil.ContextExecutor, related ...*Content) error {
	if len(related) == 0 {
		return nil
	}
