...
func TestToOneRemove(t *testing.T) {
	t.Run("ContentToCategoryUsingContents", testContentToOneRemoveOpCategoryUsingCategory)
...
func TestToManySet(t *testing.T) {
	t.Run("CategoryToContents", testCategoryToManySetOpContents)
...
func TestToManyRemove(t *testing.T) {
	t.Run("CategoryToContents", testCategoryToManyRemoveOpContents)
