...
func testUserToManyBrowses(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadBrowses(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyContents(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = randomize.Struct(seed, &b, contentDBTypes, false, contentColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, contentDBTypes, false, contentColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	...
	check, err := a.Contents().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadContents(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.Contents); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.Contents = nil
	if err = a.L.LoadContents(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.Contents); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyFavorites(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadFavorites(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyFollowerFollows(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.FollowerFollows().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadFollowerFollows(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.FollowerFollows); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.FollowerFollows = nil
	if err = a.L.LoadFollowerFollows(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.FollowerFollows); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyFollowingFollows(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.FollowingFollows().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	bFound, cFound := false, false
	for _, v := range check {
		if v.FollowingID == b.FollowingID {
			bFound = true
		}
		if v.FollowingID == c.FollowingID {
			cFound = true
		}
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadFollowingFollows(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.FollowingFollows); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.FollowingFollows = nil
	if err = a.L.LoadFollowingFollows(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.FollowingFollows); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyNotices(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadNotices(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyNoticeFavorites(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = randomize.Struct(seed, &b, noticeFavoriteDBTypes, false, noticeFavoriteColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, noticeFavoriteDBTypes, false, noticeFavoriteColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	...
	check, err := a.NoticeFavorites().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadNoticeFavorites(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.NoticeFavorites); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.NoticeFavorites = nil
	if err = a.L.LoadNoticeFavorites(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.NoticeFavorites); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyNoticeFolloweds(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = randomize.Struct(seed, &b, noticeFollowedDBTypes, false, noticeFollowedColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, noticeFollowedDBTypes, false, noticeFollowedColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	...
	check, err := a.NoticeFolloweds().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadNoticeFolloweds(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.NoticeFolloweds); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.NoticeFolloweds = nil
	if err = a.L.LoadNoticeFolloweds(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.NoticeFolloweds); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyAddOpBrowses(t *testing.T) {
	var err error
...
func testUserToManyAddOpContents(t *testing.T) {
	var err error
	...
	foreigners := []*Content{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, contentDBTypes, false, strmangle.SetComplement(contentPrimaryKeyColumns, contentColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*Content{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddContents(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.Contents[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.Contents[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.Contents().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManySetOpContents(t *testing.T) {
	var err error
	...
	err = a.SetContents(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetContents(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyRemoveOpContents(t *testing.T) {
	var err error
	...
	err = a.AddContents(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveContents(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyAddOpFavorites(t *testing.T) {
	var err error
...
func testUserToManyAddOpFollowerFollows(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddFollowerFollows(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.FollowerFollows[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.FollowerFollows[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.FollowerFollows().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManyAddOpFollowingFollows(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddFollowingFollows(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.ID != first.FollowingID {
			t.Error("foreign key was wrong value", a.ID, first.FollowingID)
		}
		if a.ID != second.FollowingID {
			t.Error("foreign key was wrong value", a.ID, second.FollowingID)
		}

		if first.R.Following != &a {
			t.Error("relationship was not added properly to the foreign slice")
		}
		if second.R.Following != &a {
			t.Error("relationship was not added properly to the foreign slice")
		}

		if a.R.FollowingFollows[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.FollowingFollows[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.FollowingFollows().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManyAddOpNotices(t *testing.T) {
	var err error
...
func testUserToManyAddOpNoticeFavorites(t *testing.T) {
	var err error
	...
	var a User
	var b, c, d, e NoticeFavorite

	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, &a, userDBTypes, false, strmangle.SetComplement(userPrimaryKeyColumns, userColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	foreigners := []*NoticeFavorite{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, noticeFavoriteDBTypes, false, strmangle.SetComplement(noticeFavoritePrimaryKeyColumns, noticeFavoriteColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*NoticeFavorite{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddNoticeFavorites(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.NoticeFavorites[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.NoticeFavorites[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.NoticeFavorites().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManyAddOpNoticeFolloweds(t *testing.T) {
	var err error
	...
	var a User
	var b, c, d, e NoticeFollowed

	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, &a, userDBTypes, false, strmangle.SetComplement(userPrimaryKeyColumns, userColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	foreigners := []*NoticeFollowed{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, noticeFollowedDBTypes, false, strmangle.SetComplement(noticeFollowedPrimaryKeyColumns, noticeFollowedColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*NoticeFollowed{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddNoticeFolloweds(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.NoticeFolloweds[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.NoticeFolloweds[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.NoticeFolloweds().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
var (
	userDBTypes = map[string]string{`ID`: `int`, `UID`: `varchar`, `Status`: `varchar`, `Email`: `varchar`, `Nickname`: `varchar`, `ThumbnailURL`: `text`, `Profile`: `varchar`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`}
	_           = bytes.MinRead
)
