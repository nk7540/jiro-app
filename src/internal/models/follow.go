...
var FollowWhere = struct {
	...
	IsClose:     whereHelperbool{field: "`follow`.`is_close`"},
...
var (
	followAllColumns            = []string{"id", "following_id", "follower_id", "is_close", "created_at", "updated_at"}
	followColumnsWithoutDefault = []string{"following_id", "follower_id", "created_at", "updated_at"}
	followColumnsWithDefault    = []string{"id", "is_close"}
