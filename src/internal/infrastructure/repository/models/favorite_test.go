...
var (
	favoriteDBTypes = map[string]string{`ID`: `int`, `UserID`: `int`, `ContentID`: `int`, `CommentID`: `int`, `ToUserIds`: `varchar`, `ToCloseUsers`: `tinyint`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`}
	_               = bytes.MinRead
)
