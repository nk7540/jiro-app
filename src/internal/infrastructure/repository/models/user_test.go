...
var (
	userDBTypes = map[string]string{`ID`: `int`, `UID`: `varchar`, `Status`: `varchar`, `Email`: `varchar`, `Nickname`: `varchar`, `ThumbnailURL`: `text`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`}
	_           = bytes.MinRead
)
