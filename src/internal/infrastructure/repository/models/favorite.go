...
var (
	favoriteAllColumns            = []string{"id", "user_id", "content_id", "comment_id", "to_user_ids", "to_close_users", "created_at", "updated_at"}
	favoriteColumnsWithoutDefault = []string{"user_id", "content_id", "comment_id", "to_user_ids", "created_at", "updated_at"}
	favoriteColumnsWithDefault    = []string{"id", "to_close_users"}
